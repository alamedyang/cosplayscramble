	...
	'page-order',
	{
		template: `
			<section class="page-order">
				...
				<h2>Magnets</h2>
				<p>Anything listed as in-stock in the <a href="#/catalog">General Catalog</a> is available to order online or at anime conventions where I have an Artist Alley table. (For a list of conventions I am attending, see the <a href="#/">Info</a> section.) Retired characters are not available for purchase except as a special order, which follow the procedure for POD magnets specified in the <a href="#/custom">Custom</a> section.</p>
				...
				<h2>Grab Bags</h2>
				<p>I have a variety of blind grab bags available online, as well as at conventions that allow them, as an affordable way to acquire characters in bulk. You will not be able to see what characters are included until you open the bag, but I sometimes limit the <em>category</em> of the bag to help narrow things down. (See the <a href="#/catalog">Catalog</a> to learn about what characters are available in each of the six color-coded categories.)</p>
